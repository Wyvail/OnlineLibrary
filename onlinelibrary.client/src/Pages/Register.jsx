        ...
        if (!email || !password || !confirmPassword) {
            ...
            fetch("/registerLibrarian?email=" + email, { // add librarian status to the database  
                ...
                .then((data) => {
                    ...
                    console.log(data);
                    if (data.ok)
                        setLibrarianStatus("Successful librarian status.");
                    else
                        setLibrarianStatus("Error registering librarian.");
                })
                .catch((error) => {
                    // handle network error
                    console.error(error);
        ...
        <div className="containerbox">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div>
                    ...
                    />
                    <label htmlFor="librarian">I am a librarian</label>
                </div>
                <div>
            ...
            {librarianStatus && <p className="librarianStatus">{librarianStatus}</p> }
        </div>
    );
}
